    ...
    <div className="bg-[#F6F6F7] pt-[64px] border-t border-[#DCDDDF] border-solid border-collapse">
      <div className="w-[1216px] mx-auto flex justify-between pb-[24px]">
        <div className="w-[289px] ">
          ...
          <p className="text-[#696A75] font-normal text-base mb-[24px]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam
          </p>
          <p className="text-[#3B3C4A] font-normal text-base mb-1">
        ...
        <div className="flex gap-[26px] ">
          ...
          <div className="cursor-pointer">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_2245_306)">
                <path
          ...
          <div className="cursor-pointer">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_2245_308)">
                <path
